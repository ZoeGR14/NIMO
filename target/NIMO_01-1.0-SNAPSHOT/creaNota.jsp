...
<html>
    ...
    <section>
        ...
        <h1 class="titulo">Crear Nota</h1>
        <form style="width: 100%;height: 86%; margin: 0;" method="post" action="Controler">
            <div class="conteNota">
                <textarea placeholder="Empieza a escribir aquí..." class="escribirNota" name="nota" required ></textarea>
            </div>
            <button class="añadirNota" name="accion" value="✔">✔</button>
