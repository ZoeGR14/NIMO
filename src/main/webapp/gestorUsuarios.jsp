            ...
            <div class="gridd">
                    ...
                    try {
                        ...
                        while (rs.next()) {
                            if (rs.getString(2).equals("1")) {
                                ...
                                tipi = "Veterinario Validado";
                            } else if (rs.getString(2).equals("3")) {
                                tipi = "Veterinario No Validado";
                            } else if (rs.getString(2).equals("4")) {
                                tipi = "Administrador";
                            } else if (rs.getString(2).equals("5")) {
                                tipi = "Gestor de Veterinarios";
                            } else if (rs.getString(2).equals("6")) {
                                tipi = "Invitado";
                            } else if (rs.getString(2).equals("7")) {
                                tipi = "Gestor de Comentarios";
                            } else if (rs.getString(2).equals("8")) {
                                tipi = "Gestor de Usuarios";
                            }
                ...
                <div class="cardContainer">
                    <div class="profileDiv">
                        <center>  
                            Usuario:&nbsp; <%=rs.getString(1)%><br>
                            Tipo:&nbsp; <%out.println(tipi);%><br>                         
                            Nombre:&nbsp; <%=rs.getString(8)%>&nbsp; <%=rs.getString(6)%>&nbsp; <%=rs.getString(7)%><br>                        
                            Teléfono:&nbsp; <%=rs.getString(3)%><br>  
                            Género:&nbsp; <%=rs.getString(4)%><br>  
                            Fecha de nacimiento:&nbsp; <%=rs.getString(5)%><br>  
                            E-mail:&nbsp; <%=rs.getString(10)%><br>  
                        </center>
                    </div>
                    <div class="infoDiv">
