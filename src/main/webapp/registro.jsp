    ...
    <body>    
        ...
        <%
                ...
                try{
                    ...
                    conec  = DriverManager.getConnection("jdbc:mysql://localhost:3308/NIMOBase?autoReconnect=true&useSSL=false","root","n0m3l0");                               
                    ...
                    if (results.next()){
                        ...
                        try{
                            Class.forName("com.mysql.jdbc.Driver");
                            conec2  = DriverManager.getConnection("jdbc:mysql://localhost:3308/NIMOBase?autoReconnect=true&useSSL=false","root","n0m3l0");                               
