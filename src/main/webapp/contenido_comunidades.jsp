    ...
            </nav>
              ...
              -->
                ...
                <%
                    ...
                    if (request.getParameter("btnPubli") != null) {
                        ...
                        paso = "insert into publicaciones(nueva_publi) values ('" + publicacion + "')";
                        Connection cnx = null;
                        ResultSet rs = null;
                        Statement sta = null;                      
                        ...
                        try {
                            ...
                            request.getRequestDispatcher("contenido_comunidades.jsp?paso="+paso2+"").forward(request, response);
                        } catch (SQLException error) {
                            out.print(error.toString());
                        }
                    }else{
                        String id_comu = request.getParameter("paso");
                        System.out.println(id_comu);
            ...
            <%
                    try{
                        ...
                        rs2 = sta2.executeQuery("select * from publicaciones where id_comu =" + id_comu + "" );
                        while (rs2.next()) {   
