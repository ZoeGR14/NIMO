                    ...
                    <div class="login-card">
                        ...
                        <div class="login-card-form">
                            <form action="" class="login-card-form">
                                <div class="form-item">
                                    Usuario:<input type="text" placeholder="Usuario" name="txtusuario"><br><br>
                                </div>
                                <div class="form-item">
                                    Fecha:<input type="date" placeholder="Fecha" name="txtfecha"><br><br>
                                </div>
                                <div class="form-item">
                                    Hora:<input type="time" placeholder="Hora" name="txthora"><br><br>
                                </div>
                                <div class="form-item">
                                    Descripción:<input type="text" placeholder="Descripción" name="txtdescripcion"><br><br>
                                </div>
        ...
        -->
                ...
                <%
                    Connection cnx = null;
                        ...
                        Statement sta = null;
                    %>
            <a href="miCalendario.jsp?cod=<%=rs.getString(2)%>" name="btnEvento" value="Subir Evento">Agendar
