...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %><html>
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
                <title>Modificando Datos de Usuario</title>
    ...
    <body>
            ...
            if(sesion.getAttribute("user")!=null && sesion.getAttribute("tipo_usuario")!=null){
                ...
                Connection conx= null;
                                ...
                                String tipe = request.getParameter("tipi");
                                int tipes = Integer.parseInt(tipo);
                                String usuari = request.getParameter("usu");           
                        ...
                        out.println("<script>setTimeout(saludos, 1500);</script>");
                                                            ...
                                                            try{
                                                            sta.executeUpdate("update usuario set nom_us='"+nom+"', apPat_us='"+apP+"', apMat_us='"+apM+"' where usuar='"+usuari+"';");
                                                                sta.executeUpdate("update usuario set telefono='"+tel+"', gen='"+sex+"', f_nac='"+naci+"' where usuar='"+usuari+"';");
                                                  out.println("<script>Swal.fire('Datos modificados correctamente','Hasta luego','success')</script>");
