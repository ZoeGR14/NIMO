...
<html>
    ...
    <body>
        ...
        <section class="sectionInformativo ventana">
                ...
                <ul>
                    <li>Perros
                        <ul>
                            <li>Razas
                                <ul>
                                    <li><a href="informacion_mascotas/Husky.jsp">Siberian Husky</a></li>
                                    <li><a href="informacion_mascotas/Chihuahua.jsp">Chihuahua</a></li>
                                    <li><a href="informacion_mascotas/Pomerania.jsp">Pomerania</a></li>
                                    <li><a href="informacion_mascotas/Pug.jsp">Pug</a></li>
                                    <li><a href="informacion_mascotas/Pastor_Ingles.jsp">Pastor Inglés</a></li>
                                    <li><a href="informacion_mascotas/Boxer.jsp">Boxer</a></li>
                                    <li><a href="informacion_mascotas/Retriever.jsp">Labrador Retriever</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li>Gatos
                        <ul>
                            <li>Razas
                                <ul>
                                    <li><a href="informacion_mascotas/Siames.jsp">Siamés</a></li>
                                    <li><a href="informacion_mascotas/Maine_Coon.jsp">Maine Coon</a></li>
                                    <li><a href="informacion_mascotas/Ragdoll.jsp">Ragdoll</a></li>
                                    <li><a href="informacion_mascotas/Ruso_Azul.jsp">Ruso Azul</a></li>
                                    <li><a href="informacion_mascotas/Siberiano.jsp">Siberiano</a></li>
                                    <li><a href="informacion_mascotas/Somali.jsp">Somalí</a></li>
                                    <li><a href="informacion_mascotas/Bobtail.jsp">Bobtail Americano</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
            ...
            <div class="info">
                <h1>¡Selecciona un tema a mostrar!</h1>
            </div>
        </section>
    </body>
