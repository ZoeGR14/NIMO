    ...
    <body>
        ...
        <section class="ventana">
            <section class="secciones">
                ...
                <article>
                    <h1 class="titulo">Insuficiencia renal crónica</h1>

                    <p class="textoOOOO">En la vejez, los gatos padecen muy frecuentemente de insuficiencia renal crónica (IRC), también conocida como enfermedad renal crónica (ERC). La insuficiencia renal en gatos es una pérdida funcional permanente de la capacidad de concentración de los riñones. La enfermedad avanza sin parar y provoca daños irreparables, de manera que el gato no muestra síntomas —vómitos, cansancio o desequilibrios de electrolitos mortales— hasta pasados unos meses, a partir de cierto nivel de gravedad.</p>

                    <center><a href="https://bit.ly/3Vf1OVL" target="_blank"><img src="https://bit.ly/3gsLLoH" class="imagenParvo"></a> </center>
                    <h2 class="subtitulos">¿Cómo se desarrolla una insuficiencia renal en gatos?</h2>
