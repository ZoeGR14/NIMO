    ...
    <img src="imagenes/fongestorVet.png" class="imagensita">
        ...
        <%
                ...
                try{
                    ...
                    rs2 = sta2.executeQuery("select * from veterinario where usuar='"+name+"';");
                    while (rs2.next()) {
        ...
        <div class="cardContainer">
            <div class="profileDiv">
                <center>  
                    Usuario:&nbsp; <%=rs.getString(1)%><br><br> 
                    Nombre:&nbsp; <%=rs.getString(8)%>&nbsp; <%=rs.getString(6)%>&nbsp; <%=rs.getString(7)%><br><br>     
                    Cédula Profesional:&nbsp;<%=rs2.getString(1)%><br><br>  
                    Ubicación de la clínica veterinaria:<br><%=rs2.getString(2)%><br><br>  
                    Teléfono:&nbsp; <%=rs.getString(3)%><br><br>   
                    E-mail:&nbsp; <%=rs.getString(10)%> 
                </center>
            </div>
            <div class="infoDiv">
                ...
                <div class="socialDiv">
                    ...
                    <a href="https://www.cedulaprofesional.sep.gob.mx/cedula/presidencia/indexAvanzada.action" class="bottar" target="_blank">
                        <img src="imagenes/buscar-vet48.png" alt="alt">
                                        </a>
                                    
                    
                    <form action="validarVetes.jsp" method="post" name="eliminaR">
                                    <input type="hidden" name="usuE" value="<%=rs.getString(1)%>" required>
                                    <button type="submit" name="manda" class="bottar">
                                        <img src="imagenes/aceptarVet.svg" alt="alt">
                                    </button>
                    </form>
