            ...
            if(sesion.getAttribute("user")!=null && sesion.getAttribute("tipo_usuario")!=null){
                ...
                Connection conx= null;
                        ...
                        out.println("<script>setTimeout(saludos, 1500);</script>");
                                                            ...
                                                            try{
                                                            sta.executeUpdate("update usuario set nom_us='"+nom+"', apPat_us='"+apP+"', apMat_us='"+apM+"' where usuar='"+usuar+"';");
                                                                sta.executeUpdate("update usuario set telefono='"+tel+"', gen='"+sex+"', f_nac='"+naci+"' where usuar='"+usuar+"';");
