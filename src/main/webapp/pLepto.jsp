    ...
    <body>
        ...
        <section class="ventana">
            <section class="secciones">
                ...
                <article>
                    <h1 class="titulo">Leptospirosis </h1>
                    <h2 class="subtitulos">¿Qué es?</h2>
                    <p class="textoOOOO">La leptospirosis es una enfermedad bacteriana de los perros que puede tener consecuencias muy graves en las mascotas y que, además, puede contagiarse a las personas.

                        <br>Esta enfermedad está causada por una bacteria espiroqueta llamada Leptospira, que se encuentra distribuida por todo el mundo. El modo de contagio habitual consiste en la contaminación del agua estancada por la orina de un animal infectado y en el posterior contacto de ese agua con una herida en la piel.  Existen muchos tipos distintos de leptospirosis. Las serovariedades que afectan con más frecuencia a los perros se denominan canicola e icterohaemorrhagiae. El perro se considera el reservorio de la serovariedad canicola. Sin embargo, la vacunación masiva contra estas serovariedades ha hecho que la enfermedad de la que son responsables resulte cada vez menos frecuente y que otras serovariedades de la bacteria, como bratislava y grippotyphosa, estén ocupando su lugar.
                    <center><a href="https://bit.ly/3hWy3uF" target="_blank"><img src="https://bit.ly/3EmBu5o"class="imagenParvo"></a> </center>
                    <h2 class="subtitulos">Síntomas</h2>
                    <p class="textoOOOO">Los síntomas observados en el perro van desde muy leves o inexistentes hasta muy graves, dando lugar en este último caso a un cuadro que rápidamente acaba en la muerte. La forma “clásica”, descrita a continuación, resulta en muchos casos menos grave y/o de evolución más lenta.</p>
                    <ul class="listitauwu">
                        <li>Fiebre alta</li>
                        <li>Gastroenteritis con vómitos o diarrea que puede contener sangre</li>
                        <li>Ictericia, debido a la alteración del hígado</li>
                        <li>Orina oscura</li>
                        <li>Deshidratación</li>
                        <li>Congestión de la mucosa</li>
                        <li>Letargo</li>
                        <li>Insuficienta renal aguda</li>
                        <li>Muerte del animal</li>

                    </ul><br><br>
                    <center><a href="https://bit.ly/3hWy3uF" target="_blank"><img src="https://bit.ly/3ENQL0z" class="imagenParvo"></a> </center>
                </article>
            </section>
        </section>
        <script>
