                ...
                Connection conx= null;
                                                ...
                                                try{
                                                    ...
                                                    String usu = request.getParameter("usuE");
                                                        ...
                                                        if(!res.next()){
                        out.println("<script>Swal.fire({icon: 'error',title: 'No existe el usuario',text: 'Inténtelo de nuevo'});</script>");
                        ...
                        out.println("<script>setTimeout(saludos, 1500);</script>");
                                                            ...
                                                            sta.executeUpdate("delete from usuario where usuar='"+usu+"';");
                                                            
                                                  out.println("<script>Swal.fire('Usuario eliminado','','success')</script>");
                                out.println("<script>function saludos(){location.href ='gestorUsuarios.jsp';}</script>");
