...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %><html>
    ...
    <body>
        ...
        <section class="sectionInformativo ventana">
            ...
            <div class="info">
                <h1 class="raza">Siberiano</h1>
                <img src="../animalesFotos/siberiano.jpg" alt="" draggable="false"/>
                
                <div class="g-caract">
                    <h2>Caracteristicas:</h2>
                    <ul>
                        <li>La característica física principal de un gato siberiano es su frondoso pelaje que consta de 3 capas.</li>
                        <li>El color en el pelaje y los ojos son todos aceptados menos el chocolate y el violeta.</li>
                        <li>Sus ojos son redondos y marcadamente expresivos</li>
                        <li>Su peso varía entre 4.5 - 9 kg.</li>
                        <li>La espalda de estos gatos está algo arqueada debido a que sus patas traseras son algo más largas a las delanteras.</li>
                        <li></li>
                    </ul>
                </div>
                <div class="g-cuidados">
                    ...
                    <ul>
                        <li>Se debe tener especial atención en el mantenimiento de su pelaje. Es recomendable un cepillado habitual para evitar nudos y bolas de pelo.
                        Con dos o tres veces a la semana será suficiente.</li>
                        <li>Se recomienda no bañarlo, o al menos no frecuentemente.</li>
                        <li>Es aconsejable los baños en seco, pero deben llevarse a cabo por buenos profesionales.</li>
                    </ul>
                </div>
                <div class="g-act-hab">
                    <h2>Actitudes y Habilidades:</h2>
                    <ul>
                        <li>Contrario a lo que su aspecto dice, son muy sociables, afebles y cariñosos.</li>
                        <li>Se adapta bien al trato con otros gatos y animales.</li>
                        <li>Constantemente piden atención y cariño.</li>
                        <li>Inicialmente, son muy tímidos con desconocidos; puede llevarles tiempo perder esa timidez.</li>
                        <li>Al principio pueden tener una conducta de carácter huidizo, pero una vez agarrando confianza, no dudarán en ponerse panza arriba y ronronear alegremente ante las caricias.</li>
                    </ul>
                </div>
            </div>
        </section>
