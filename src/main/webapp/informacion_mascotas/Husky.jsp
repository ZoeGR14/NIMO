...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %><html>
    ...
    <body>
        ...
        <section class="sectionInformativo ventana">
            ...
            <div class="info">
                <h1 class="raza">Siberian Husky</h1>
                <img src="../animalesFotos/husky.jpg" alt="" draggable="false"/>

                <div class="p-caract">
                    <h2>Caracteristicas:</h2>
                    <ul>
                        <li>Son perros de tamaño medio ligeramente más largo que alto.</li>
                        <li>Tienen un pelo muy denso y afelpado con una importante capa interna.</li>
                        <li>Tienen un pequeño collar de pelo alrededor del cuello, pero no tienen flecos largos en las patas ni en la cola.</li>
                        <li>Las mayoría de estos perros tienen marcas blancas, especialmente en el pecho y las patas.</li>
                        <li>Por lo general no ladran, aúllan.</li>
                    </ul>
                </div>
                <div class="p-cuidados">
                    <h2>Cuidados especiales:</h2>
                    <ul>
                        <li>Es importante cepillarlo bien al menos una vez a la semana y diariamente.</li>
                        <li>Utilizar shampoo especial para perros cuando se bañe.</li>
                        <li>En caso de que no se desgaste sus uñas con el tiempo, tendrás que cortarlas al menos una o dos veces al mes.</li>
                        <li>Cepillar los dientes del Husky dos o tres veces a la semana, para eliminar el sarro y las bacterias.</li>
                        <li>Revisa sus oídos semanalmente para evitar infecciones. Limpia solamente el oído externo.</li>
                    </ul>
                </div>
                <div class="p-act-hab">
                    <h2>Actitudes y Habilidades:</h2>
                    <ul>
                        <li>Son perros cariñosos, juguetones y afables.</li>
                        <li>Su temperamento puede cambiar cuando se encuentra con desconocidos.</li>
                        <li>Es una raza que disfruta la compañía de otros perros.</li>
                        <li>Es capaz de correr grandes distancias y tiene tendencia a escaparse.</li>
                    </ul>
                </div>
            </div>
        </section>
