...
<html>
    ...
    <body>
        ...
        <section class="sectionInformativo ventana">
            ...
            <div class="info">
                <h1 class="raza">Ragdoll</h1>
                <img src="../animalesFotos/ragdoll.jpg" alt="" draggable="false"/>
                
                   <div class="g-caract">
                    <h2>Caracteristicas:</h2>
                    <ul>
                        <li>Raza de gatos de tamaño grande, fuerte, compacto y musculosos.</li>
                        <li>Con cuerpo ligeramente largo</li>
                        <li>Peso promedio: 3.5 - 9 kg</li>
                        <li>La cabeza de estos gatitos es mediana, ancha y con apariencia redonda.</li>
                        <li>Una de las principales características del gatuno son sus ojos grandes, ovalados y de color azul intenso.</li>
                        <li>El pelo de esta raza de gatos es semilargo, denso, suave y sedoso.</li>
                    </ul>
                </div>
                <div class="g-cuidados">
                    <h2>Cuidados especiales:</h2>
                    <ul>
                        <li>Es recomendable cepillar al gato una vez al día, o al menos dos o tres veces por semana.</li>
                        <li>Mantenerlo correctamente estimulado, tanto física como mentalmente.</li>
                        <li>Hacerlo disfrutar de un adecuado enriquecimiento ambiental.</li>
                        <li>Correcta alimentación para evitar desarrollar sobrepeso.</li>
                        <li>Debe contar con un lugar cómodo y seguro para descansar, agua limpia y un arenero.</li>
                    </ul>
                </div>
                <div class="g-act-hab">
                    <h2>Actitudes y Habilidades:</h2>
                    <ul>
                        <li>Caracterizados por ser muy dóciles.</li>
                        <li>Son muy sociables y tolerantes, se lleva muy bien con otros gatos, animales y niños.</li>
                        <li>No tiende a maullar mucho, prefiere emitir otro tipo de sonidos más debiles y delicados para comunicarse.</li>
                        <li>Son muy tranquilos, cariñosos y pacíficos.</li>
                        <li>Juguetones y curiosos por naturaleza, les adora descubrir cosas nuevas.</li>
                    </ul>
                </div>
            </div>
        </section>
