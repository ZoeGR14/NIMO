...
<html>
    ...
    <body>
        ...
        <section class="sectionInformativo ventana">
            ...
            <div class="info">
                <h1 class="raza">Pug</h1>
                <img src="../animalesFotos/pug.jpg" alt="" draggable="false"/>
                
                <div class="p-caract">
                    <h2>Caracteristicas:</h2>
                    <ul>
                        <li>Son perros de raza pequeña, miden entre 30 - 40 cm.</li>
                        <li>Su peso va de los 6 hasta los 8 kilos.</li>
                        <li>Mudan mucho de pelo.</li>
                        <li>La esperanza de vida de estos perrunos ronda los 12 - 15 años.</li>
                        <li>Esta raza de perros no soporta del todo bien las temperaturas o la humedad, debido a que el aire no se enfría antes de llegar a sus pulmones.</li>
                        <li>Tienen tendencia al sobrepeso.</li>
                        <li>Son braquicéfalos y sus grandes y prominentes ojos implican la aparición de diversos problemas de salud.</li>
                    </ul>
                </div>
                <div class="p-cuidados">
                    <h2>Cuidados especiales:</h2>
                    <ul>
                        <li>Se debe proteger al perruno del calor y la humedad.</li>
                        <li>Un pug no suele desgastar sus uñas, por lo que es necesario cortárselas.</li>
                        <li>Procurar que sus orejas estén limpias siempre.</li>
                        <li>Al ser propenso a sobrepeso, se debe medir sus raciones y darle comida de alta calidad.</li>
                        <li>Las arrugas faciales o pliegues del perruno requieren un higiene especial, pues es una zona en la que se acumulan muchas bacterias. Pueden ocuparse toallitas higiénicas para limpiar los pliegues.</li>
                        <li>Tener MUCHO cuidado con sus ojos saltones, pues son vulnerables a lesiones y también a irritaciones por el jabón de baño u otras sustancias.</li>
                        <li>Los pugs son propensos a sufrir infecciones de encías; para evitarlo hay que cepillarle sus dientes regularmente.</li>
                    </ul>
                </div>
                <div class="p-act-hab">
                    <h2>Actitudes y Habilidades:</h2>
                    <ul>
                        <li>Son conocidos como perros de compañía; son muy tranquilos, juguetones y divertidos.</li>
                        <li>Es algo testarudo y necesita un entrenamiento consistente y socialización temprana para convertirse en un perro de carácter equilibrado</li>
                        <li>Un pug se lleva muy bien con los niños.</li>
                        <li>No toleran la soledad y buscarán tu compañía siempre (awwww).</li>
                    </ul>
                </div>
            </div>
        </section>
