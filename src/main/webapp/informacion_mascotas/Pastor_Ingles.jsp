...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %><html>
    ...
    <body>
        ...
        <section class="sectionInformativo ventana">
            ...
            <div class="info">
                <h1 class="raza">Pastor Inglés</h1>
                <img src="../animalesFotos/pastorIngles.jpg" alt="" draggable="false"/>
                  <div class="p-caract">
                    <h2>Caracteristicas:</h2>
                    <ul>
                        <li>Es una raza de tamaño grande, miden hasta 61 centimetros y las hembras unos 55 centímetros.</li>
                        <li>El peso en los machos suele estar alrededor de 29 kg y el de las hembras entre los 27 kg.</li>
                        <li>Sus orejas son pequeñas y cuelgan a los lados de la cabeza.</li>
                        <li>Sus ojos están bien separados entre sí.</li>
                        <li>Presentan mandíbula en tijera.</li>
                        <li>Esta raza suele nacer sin cola, y si llegan a tenerla, se les amputa completamente.</li>
                        <li>Tiene mucho pelaje, el cual es largo, duro y denso.</li>
                    </ul>
                </div>
                <div class="p-cuidados">
                    <h2>Cuidados especiales:</h2>
                    <ul>
                        <li>No es una raza que coma poco, de hecho, necesita bastante comida para que tenga la energía necesaria para vivir saludablemente, por lo que es indispensable ofrecerle una buena cantidad de alimento.</li>
                        <li>Se necesita una gran dosis de actividad y paseos, pues de no llevarse a cabo podría derivar en problemas graves de estrés y frustración por parte del perruno.</li>
                        <li>Cepillarlo de forma diaria</li>
                        <li>Al tener un pelo largo y susceptible a enredos debemos ser conscientes de que deberemos llevarlo a la peluquería (un coste económico) o bien aprender a cortarle nosotros mismos el pelo</li>
                    </ul>
                </div>
                <div class="p-act-hab">
                    <h2>Actitudes y Habilidades:</h2>
                    <ul>
                        <li>Dueños de Pastores Ingleses se refieren a esta raza como "un perro muy humano"</li>
                        <li>Se trata de canes pacientes, afectuosos, cariñosos.</li>
                        <li>Son dóciles y de buen carácter, fieles, adaptables, y dignos de confianza.</li>
                    </ul>
                </div>
            </div>
        </section>
