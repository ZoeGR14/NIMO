...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %><html>
    ...
    <body>
        ...
        <section class="sectionInformativo ventana">
            ...
            <div class="info">
                <h1 class="raza">Ruso Azul</h1>
                <img src="../animalesFotos/rusoAzul.jpg" alt="" draggable="false"/>
                
                <div class="g-caract">
                    <h2>Caracteristicas:</h2>
                    <ul>
                        <li>Esta raza es de tamaño medio, posee huesos finos y es musculoso.</li>
                        <li>Su pelaje es corto, sedoso, denso y de aspecto similar a la felpa</li>
                        <li>Posee unos ojos grandes, redondeados y de color verde intenso.</li>
                        <li>La forma de cabeza es una cuña amplia y mediana, con la parte superior plana y una nariz recta de perfil.</li>
                        <li>Las orejas son anchas en la base y quedan ligeramente volteadas hacia el exterior.</li>
                    </ul>
                </div>
                <div class="g-cuidados">
                    <h2>Cuidados especiales:</h2>
                    <ul>
                        <li>Tener un cepillado regular para tenerlo impoluto.</li>
                        <li>Bañarlo en caso de que esté muy sucio, no es necesario bañarlo regularmente.</li>
                        <li>Revisar sus orejas ocasionalmente para asegurarnos que no sufra infestación de ácaros.</li>
                        <li>Elegir un <a href="https://www.businessinsider.es/mejores-piensos-gatos-puedes-comprar-847531" target="_blank">pienso de calidad</a> y de la gama correspondiente (<i>junior, adult o senior</i>)</li>
                        <li>Situar el arenero, la comida y su cama en zonas muy separadas.</li>
                        <li>Tener juguetes variados, especialmente del tipo "caña de pescar".</li>
                    </ul>
                </div>
                <div class="g-act-hab">
                    <h2>Actitudes y Habilidades:</h2>
                    <ul>
                        <li>Suelen tener vínculos muy fuertes con su familia y en especial con uno de sus miembros.</li>
                        <li>Son tranquilos y cariñosos, pero suelen ser reservados con gente desconocida.</li>
                        <li>Son gatos muy tolerantes con los niños.</li>
                        <li>Se adaptan facilmente a una vida en un apartamento, siempre que reciba afecto constante y puedas jugar con él.</li>
                        <li>Destacan por su inteligencia, aprenden muy rápido a relacionar su nombre y a utilizar diferentes elementos.</li>
                    </ul>
                </div>
            </div>
        </section>
