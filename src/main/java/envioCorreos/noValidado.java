...
public class noValidado {
    ...
    public String transfer_to_mail(String Correo){
        ...
        String mensaje = "Lo lamentamos, pero tu cédula profesional no ha podido ser validada\n Tu registro ha sido modificado, y tu tipo de usuario ahora es 'Cliente'";
